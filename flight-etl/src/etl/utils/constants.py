...
bronze_flight_filepath = DATA_DIR / bronze_flight_path / bronze_flight_filename
silver_flight_filepath = DATA_DIR / silver_flight_path / silver_flight_filename
gold_flight_filepath = DATA_DIR / gold_flight_path / gold_flight_filename
discarded_flight_filepath = DATA_DIR / discarded_flight_path / discarded_flight_filename
...
airport_location_filepath = DATA_DIR / airport_location_path / airport_location_filename
...
bronze_weather_filepath = DATA_DIR / bronze_weather_path / bronze_weather_filename
silver_weather_filepath = DATA_DIR / silver_weather_path / silver_weather_filename
...
gold_merged_filepath = DATA_DIR / gold_merged_path / gold_merged_filename
feature_store_filepath = DATA_DIR / feature_store_path / feature_store_filename
